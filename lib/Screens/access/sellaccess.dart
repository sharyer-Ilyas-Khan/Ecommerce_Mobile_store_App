...
class SellAccessories extends StatefulWidget {
  const SellAccessories({Key key}) : super(key: key);

  @override
  _SellAccessoriesState createState() => _SellAccessoriesState();
}

class _SellAccessoriesState extends State<SellAccessories> {
  double height=0;
  double width=0;
