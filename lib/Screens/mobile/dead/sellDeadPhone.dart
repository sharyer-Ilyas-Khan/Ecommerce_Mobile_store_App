...
class SellDeadPhone extends StatefulWidget {
  const SellDeadPhone({Key key}) : super(key: key);

  @override
  _SellDeadPhoneState createState() => _SellDeadPhoneState();
}

class _SellDeadPhoneState extends State<SellDeadPhone> {
